...
resource "aws_sqs_queue" "my_action" {
  ...
  receive_wait_time_seconds  = 20     # Se a fila estiver vazia, o pooling aguarda este periodo antes de retornar um pacote vazio ao consumidor. Se uma mensagem entrar na fila neste intervalo, é encaminhada na hora para o consumidor (max 20 segundos)
