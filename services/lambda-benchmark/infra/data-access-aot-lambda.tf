# Para habiltiar/desabilitar o deploy da function, atualize a constante "deploy_benchmark_data_access_aot" no arquivo "locals.tf".
...
resource "null_resource" "publish_benchmark_data_access_aot" {
  count = local.deploy_benchmark_data_access_aot ? 1 : 0
